package vasquez.app.anotacion30.procesador;

import vasquez.app.anotacion30.Init;
import vasquez.app.anotacion30.JsonAtributo;
import vasquez.app.anotacion30.procesador.exception.JsonSerializadorException;
                ...
                .forEach(m -> {
                    ...
                    try {
                        ...
                        throw new JsonSerializadorException(
                                "Error al serializar, no se puede iniciar el objeto." + e.getMessage());
                    }
                });
    }

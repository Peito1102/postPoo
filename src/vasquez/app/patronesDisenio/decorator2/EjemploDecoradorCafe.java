package vasquez.app.patronesDisenio.decorator2;

import vasquez.app.patronesDisenio.decorator2.decorador.ConChocolateDecorador;
import vasquez.app.patronesDisenio.decorator2.decorador.ConCremaDecorador;
import vasquez.app.patronesDisenio.decorator2.decorador.ConLecheDecorador;
...
public class EjemploDecoradorCafe {
    public static void main(String[] args) {
        ...
        System.out.println("El precio dedl café moca es: " + conChoco.getPrecioBase());
        ...
        System.out.println("El precio dedl café moca es: " + conLeche.getPrecioBase());
        System.out.println("Los ingredientes: " + conLeche.getIngredientes());
        System.out.println();

        Configurable espresso = new Cafe(3,"Cafe Espresso");
        System.out.println("El precio dedl café moca es: " + espresso.getPrecioBase());
